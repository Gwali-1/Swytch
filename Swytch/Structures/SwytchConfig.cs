...
public class SwytchConfig
{
    ...
    /// <summary>
    /// Enable the static file serving action built into Swytch ,allowing you to quickly serve files in the static directory by hitting the /swytchserver/static/{filename}.
    /// </summary>
    ...
    /// indicate how long a static content served from the SwytchApp ie if you have set EnableStaticFileServer
